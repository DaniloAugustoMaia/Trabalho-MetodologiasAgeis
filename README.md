...
## 8 - Simulação
Um cliente chega no restaurante e pede opção vegana, tem uma conversa com um dos atendentes e cita a ideia de não haver nada que não tenha origem animal no cardápio. Porém, como nosso estabelecimento é novo e ainda está em desenvolvimento nós ainda não tínhamos nenhuma opção no menu não contendo nada FORA de origem animal. Então a ideia fora passada para o cozinheiro e o proprietário, o proprietário, concordou que seria algo inovador na região, que traria um público que havia poucas opções até o momento. O cozinheiro com o que havia no momento, pimentão da vinagrette, por exemplo. Com os elementos não animais de outros pratos, fez um prato que foi aprovado pelo cliente. Com elementos já conhecidos, resolvemos o problema do cliente, que saiu satisfeito.
